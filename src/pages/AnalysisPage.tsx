...
import { ArrowLeft, Copy, ThumbsUp, ThumbsDown, Lightbulb, Heart, MessageSquare, Target, TrendingUp, Brain, AlertCircle, Sparkles, CheckCircle, Star, AlertTriangle, BarChart, User, ShieldCheck } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              <Link to="/" className="flex items-center space-x-2 text-gray-600 hover:text-blue-700 px-3 py-2 rounded-lg hover:bg-blue-50 transition-colors">
